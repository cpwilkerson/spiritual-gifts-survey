  ...
  render () {
    return (
      <div className="spiritual-gifts-survey-wrapper">
        ...
        <button className="fit-to-width"
          onClick={() => {
            this.setState({fitToWidth: !this.state.fitToWidth});
          }}>
          {this.state.fitToWidth ? 'Full Size Graph' : 'Fit Graph To Width'}
        </button>
        <div className="sps-graph">
          <svg x="0" y="0"
            width={this.state.fitToWidth ? '100%' : '1123.818'}
            height="691.362" viewBox="0, 0, 1123.818, 591.362">
